...
show_connection_info() {
    ...
    echo -e "    • Hugr GraphQL:  http://localhost:19000/query"
    echo -e "    • Keycloak:      http://localhost:19005 (console: http://localhost:19005/admin/hugr/console)"
    echo -e "    • MinIO Console: http://localhost:19004"
    echo -e "    • MCP Inspector: http://localhost:19007"
    echo ""
    echo -e "  ${BLUE}Database Connections:${NC}"
    echo -e "    • PostgreSQL:    postgresql://hugr:hugr@localhost:19001/hugr"
    echo -e "    • Redis:         redis://localhost:19002"
    echo -e "    • MinIO S3 API:  http://localhost:19003 (minioadmin / minioadmin)"
    echo ""
